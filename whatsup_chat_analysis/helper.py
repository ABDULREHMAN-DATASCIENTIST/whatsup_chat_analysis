...
def emoji_helper(selected_user, df):
    ...
    pattern = r'\N{THUMBS UP SIGN}|\N{SMILING FACE WITH SMILING EYES}|\N{FACE WITH TEARS OF JOY}'  # Add more emojis as needed
    emojis = [emoji for message in df['message'] for emoji in re.findall(pattern, message)]
